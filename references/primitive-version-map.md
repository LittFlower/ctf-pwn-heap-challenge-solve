...
4. Choose one candidate technique family. Use `how2heap-selector.md` for the first cut, then the specialized selector that matches the corridor: `how2heap-legacy-writeup-labels.md`, `heap-address-leaks.md`, `offbynull-heap.md`, `how2heap-overlap-nullbyte.md`, `how2heap-mmap-overlap.md`, `how2heap-fake-free-primitives.md`, `how2heap-freelist-primitives.md`, `how2heap-safe-linking.md`, `how2heap-bin-attacks.md`, `how2heap-bin-write-primitives.md`, `house-water-and-stash-fengshui.md`, or `how2heap-wilderness-and-arena.md`.
