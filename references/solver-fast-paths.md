...
| Unsorted / smallbin / largebin / stash wording | `how2heap-bin-attacks.md`, `smallbin-techniques.md` for same-size smallbin cases, `how2heap-bin-write-primitives.md`, `largebin-geometry-checklist.md` | Whether the first stable result is a write, fake-chunk return, or stash-assisted mixed effect |
